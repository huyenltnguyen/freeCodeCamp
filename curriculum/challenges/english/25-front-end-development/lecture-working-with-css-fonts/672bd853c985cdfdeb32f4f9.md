...
The color is written after the offset but you can also write the color before the offset if you prefer. It's equivalent:
...
Here, the blur radius is set to `3px` and you're back to positive values for the offset:
